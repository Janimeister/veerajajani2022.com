...
- **UI Libraries**: PrimeNG 13, Bootstrap 5
...
src/
  app/
    ...
    navigation-menu/     # PrimeNG TabMenu navigation bar
...
- Generate new components with `npx ng generate component <name>` so the CLI scaffolds all four files and updates `AppModule` automatically.
